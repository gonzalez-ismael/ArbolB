...
public class ArbolM {
     ...
     */
    private void recorridoNivel(Nodo r, int nivel) {
        if (r != null) {
            if (nivel == 0) {
                r.mostrarClaves();
            } else {
     ...
     * @param r es el nodo actual.
     */
    private void recorridoPreorden(Nodo r) {
        if (r != null) {
     ...
     * @param r es el nodo actual.
     */
    private void recorridoEnorden(Nodo r) {
        if (r != null) {
            int nClaves = r.getCantClaves();
     ...
     * @param r es el nodo actual.
     */
    private void recorridoPostorden(Nodo r) {
        if (r != null) {
            int nClaves = r.getCantClaves();
